...
{
	global $lang;
	return "<a href='".$_SERVER[REQUEST_URI]."&help=1' onclick='openHelp(\"".$name."\"); return false;' class='helpq' title='".$lang['help'].": ".$name."' target='_blank'><span>[?]</span></a>";	
}
...
if(!$auth->isAuthorized()) //user is not authorized - display the login screen
{
	...
	echo "<span style='font-size:11px;'>Standard Password: admin</span><br />";
	...
	echo "<div style='width:100%; text-align:right; font-size:11px;'>Created by <a href='https://sven-goessling.de' target='_blank'>Sven Goessling</a></div></span></div>";
}
else //user is authorized - display the main application
{
	...
	if(sizeof($databases)<10) //if there aren't a lot of databases, just show them as a list of links instead of drop down menu
	{
		...
		foreach($databases as $database)
		{
			...
			if($database == $_SESSION[COOKIENAME.'currentDB'])
				echo "<a href='".$_SERVER[REQUEST_URI]."&switchdb=".urlencode($database['path'])."' class='active_db'>".htmlencode($database['name'])."</a>  (<a href='".htmlencode($url_path)."' title='".$lang['backup']."'>&darr;</a>)";
			else
				echo "<a href='".$_SERVER[REQUEST_URI]."&switchdb=".urlencode($database['path'])."'>".htmlencode($database['name'])."</a>  (<a href='".htmlencode($url_path)."' title='".$lang['backup']."'>&darr;</a>)";
	...
	for($i=0; $i<sizeof($result); $i++)
	{
		if(substr($result[$i]['name'], 0, 7)!="sqlite_" && $result[$i]['name']!="")
		{
			...
			echo "<a href='".$_SERVER[REQUEST_URI]."&action=row_view&amp;table=".urlencode($result[$i]['name']).($result[$i]['type']=='view'?'&amp;view=1':'')."'";
	...
	if(isset($_GET['table']))
		echo " &rarr; <a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_view'>".htmlencode($_GET['table'])."</a>";
	echo "<br/><br/>";
	...
	if(isset($_GET['confirm']))
	{
		...
		if($_GET['action']=="row_delete" || $_GET['action']=="row_create" || $_GET['action']=="row_edit")
			echo "<br/><br/><a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_view'>".$lang['return']."</a>";
			...
			echo "<br/><br/><a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_view'>".$lang['return']."</a>";
		else
	...
	if(!isset($_GET['confirm']) && isset($_GET['table']) && isset($_GET['action']) && ($_GET['action']=="table_export" || $_GET['action']=="table_import" || $_GET['action']=="table_sql" || $_GET['action']=="row_view" || $_GET['action']=="row_create" || $_GET['action']=="column_view" || $_GET['action']=="table_rename" || $_GET['action']=="table_search" || $_GET['action']=="table_triggers"))
	{
		if(!isset($_GET['view']))
		{
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_view' ";
			if($_GET['action']=="row_view")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['browse']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_view' ";
			if($_GET['action']=="column_view")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['struct']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_sql' ";
			if($_GET['action']=="table_sql")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['sql']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_search' ";
			if($_GET['action']=="table_search")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['srch']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_create' ";
			if($_GET['action']=="row_create")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['insert']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_export' ";
			if($_GET['action']=="table_export")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['export']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_import' ";
			if($_GET['action']=="table_import")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['import']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_rename' ";
			if($_GET['action']=="table_rename")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['rename']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&action=table_empty&amp;table=".urlencode($_GET['table'])."' ";
			echo "class='tab empty'";
			echo ">".$lang['empty']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&action=table_drop&amp;table=".urlencode($_GET['table'])."' ";
			echo "class='tab drop'";
			echo ">".$lang['drop']."</a>";
		...
		{
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_view&amp;view=1' ";
			if($_GET['action']=="row_view")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['browse']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_view&amp;view=1' ";
			if($_GET['action']=="column_view")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['struct']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_sql&amp;view=1' ";
			if($_GET['action']=="table_sql")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['sql']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_search&amp;view=1' ";
			if($_GET['action']=="table_search")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['srch']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_export&amp;view=1' ";
			if($_GET['action']=="table_export")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			echo ">".$lang['export']."</a>";
			echo "<a href='".$_SERVER[REQUEST_URI]."&action=view_drop&amp;table=".urlencode($_GET['table'])."&amp;view=1' ";
			echo "class='tab drop'";
			echo ">".$lang['drop']."</a>";
			echo "<div style='clear:both;'></div>";
		}
		...
		switch($_GET['action'])
		{
			...
			case "table_create":
				...
				else
				{
					...
					$name = $_POST['tablename'];
					echo "<form action='".$_SERVER[REQUEST_URI]."&action=table_create&amp;confirm=1' method='post'>";
			...
			case "table_sql":
				...
				if(!isset($_GET['view']))
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_sql' method='post'>";
				else
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_sql&amp;view=1' method='post'>";
			...
			/////////////////////////////////////////////// empty table
			case "table_empty":
				echo "<form action='".$_SERVER[REQUEST_URI]."&action=table_empty&amp;confirm=1' method='post'>";
			...
			/////////////////////////////////////////////// drop table
			case "table_drop":
				echo "<form action='".$_SERVER[REQUEST_URI]."&action=table_drop&amp;confirm=1' method='post'>";
				echo "<input type='hidden' name='tablename' value='".htmlencode($_GET['table'])."'/>";
				echo "<div class='confirm'>";
			...
			/////////////////////////////////////////////// drop view
			case "view_drop":
				echo "<form action='".$_SERVER[REQUEST_URI]."&action=view_drop&amp;confirm=1' method='post'>";
			...
			case "table_import":
				...
				echo "<form method='post' action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_import' enctype='multipart/form-data'>";
			...
			/////////////////////////////////////////////// rename table
			case "table_rename":
				echo "<form action='".$_SERVER[REQUEST_URI]."&action=table_rename&amp;confirm=1' method='post'>";
				...
				if(isset($_GET['done']))
				{
					...
					if(sizeof($result)>0)
					{
						...
						for($j=0; $j<sizeof($result); $j++)
						{
							...
							$cVal = 0;
							echo "<tr>";
							echo $tdWithClass."<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($table)."&amp;action=row_editordelete&amp;pk=".urlencode($pk)."&amp;type=edit' title='".$lang['edit']."' class='edit'><span>".$lang['edit']."</span></a></td>"; 
							echo $tdWithClass."<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($table)."&amp;action=row_editordelete&amp;pk=".urlencode($pk)."&amp;type=delete' title='".$lang['del']."' class='delete'><span>".$lang['del']."</span></a></td>";
							for($z=0; $z<sizeof($headers); $z++)
							{
								echo $tdWithClass;
					...
					if(!isset($_GET['view']))
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_search'>".$lang['srch_again']."</a>";
					else
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_search&amp;view=1'>".$lang['srch_again']."</a>";
				}
				else
				{
					$query = "PRAGMA table_info(".$db->quote_id($_GET['table']).")";
					...
					if(!isset($_GET['view']))
						echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_search&amp;done=1' method='post'>";
					else
						echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=table_search&amp;view=1&amp;done=1' method='post'>";
			...
			case "row_view":
				...
				if($_POST['startRow']>0)
				{
					...
					echo "<form action='".$_SERVER[REQUEST_URI]."&action=row_view&amp;table=".urlencode($table).$is_view."' method='post'>";
				...
				if(sizeof($arr)>0)
				{
					...
					if(!isset($_SESSION[COOKIENAME.'viewtype']) || $_SESSION[COOKIENAME.'viewtype']=="table")
					{
						echo "<form action='".$_SERVER[REQUEST_URI]."&action=row_editordelete&amp;table=".urlencode($table).$is_view."' method='post' name='checkForm'>";
						echo "<table border='0' cellpadding='2' cellspacing='1' class='viewTable'>";
						echo "<tr>";
						if(!isset($_GET['view']))
						...
						for($i=0; $i<sizeof($result); $i++)
						{
							echo "<td class='tdheader'>";
							if(!isset($_GET['view']))
								echo "<a href='".$_SERVER[REQUEST_URI]."&action=row_view&amp;table=".urlencode($table)."&amp;sort=".urlencode($result[$i]['name']);
							else
								echo "<a href='".$_SERVER[REQUEST_URI]."&action=row_view&amp;table=".urlencode($table)."&amp;view=1&amp;sort=".urlencode($result[$i]['name']);
							if(isset($_SESSION[COOKIENAME.'sortRows']))
						...
						for($i=0; $i<sizeof($arr); $i++)
						{
							...
							if(!isset($_GET['view']))
							{
								...
								echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($table)."&amp;action=row_editordelete&amp;pk=".urlencode($pk)."&amp;type=edit' title='".$lang['edit']."' class='edit'><span>".$lang['edit']."</span></a>";
								echo "</td>";
								echo $tdWithClass;
								echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($table)."&amp;action=row_editordelete&amp;pk=".urlencode($pk)."&amp;type=delete' title='".$lang['del']."' class='delete'><span>".$lang['del']."</span></a>";
								echo "</td>";
							}
							for($j=0; $j<sizeof($result); $j++)
							{
					...
					else
					{
						...
						echo "<form action='".$_SERVER[REQUEST_URI]."&action=row_view&amp;table=".urlencode($_GET['table']).$is_view."' method='post'>";
				...
				{
					echo "<br/><br/>".$lang['empty_tbl']." <a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_create'>".$lang['click']."</a> ".$lang['insert_rows'];
				}
			...
			case "row_create":
				$fieldStr = "";
				echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_create' method='post'>";
				...
				$query = "PRAGMA table_info(".$db->quote_id($_GET['table']).")";
				$result = $db->selectArray($query);
				echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_create&amp;confirm=1' method='post'>";
				if(isset($_POST['num']))
					$num = $_POST['num'];
				else
					$num = 1;
			...
			case "row_editordelete":
				...
				else
				{
					...
					{
						echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_edit&amp;confirm=1&amp;pk=".urlencode($pkVal)."' method='post'>";
						$query = "PRAGMA table_info(".$db->quote_id($_GET['table']).")";
						$result = $db->selectArray($query);
						...
						for($j=0; $j<sizeof($pks); $j++)
						{
							...
							echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_view'>".$lang['cancel']."</a>";
							echo "</td>";
							echo "</tr>";
							echo "</table>";
							echo "<br/>";
					...
					{
						echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=row_delete&amp;confirm=1&amp;pk=".urlencode($pkVal)."' method='post'>";
						echo "<div class='confirm'>";
			...
			case "column_view":
				...
				echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_confirm' method='post' name='checkForm'>";
				echo "<table border='0' cellpadding='2' cellspacing='1' class='viewTable'>";
				echo "<tr>";
				if(!isset($_GET['view']))
					echo "<td colspan='3'></td>";
				...
				for($i=0; $i<sizeof($result); $i++)
				{
					...
					if(!isset($_GET['view']))
					{
						...
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_edit&amp;pk=".urlencode($fieldVal)."' title='".$lang['edit']."' class='edit'><span>".$lang['edit']."</span></a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_confirm&amp;action2=column_delete&amp;pk=".urlencode($fieldVal)."' title='".$lang['del']."' class='delete'><span>".$lang['del']."</span></a>";
						echo "</td>";
					}
					echo $tdWithClass;
				...
				{
					echo "<br/>";
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_create' method='post'>";
					echo "<input type='hidden' name='tablename' value='".htmlencode($_GET['table'])."'/>";
				...
				if(!isset($_GET['view']))
				{
					...
					if(sizeof($result)>0)
					{
						...
						for($i=0; $i<sizeof($result); $i++)
						{
							...
							echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=index_delete&amp;pk=".urlencode($result[$i]['name'])."' title='".$lang['del']."' class='delete'><span>".$lang['del']."</span></a>";
							echo "</td>";
					...
					if(sizeof($result)>0)
					{
						...
						for($i=0; $i<sizeof($result); $i++)
						{
							...
							echo "<tr>";
							echo $tdWithClass;
							echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=trigger_delete&amp;pk=".urlencode($result[$i]['name'])."' title='".$lang['del']."' class='delete'><span>".$lang['del']."</span></a>";
							echo "</td>";
							echo $tdWithClass;
					...
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=index_create' method='post'>";
					echo "<input type='hidden' name='tablename' value='".htmlencode($_GET['table'])."'/>";
					...
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=trigger_create' method='post'>";
					echo "<input type='hidden' name='tablename' value='".htmlencode($_GET['table'])."'/>";
					echo "<br/><div class='tdheader'>";
			...
			case "column_create":
				...
				else
				{
					$num = intval($_POST['tablefields']);
					$name = $_POST['tablename'];
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_POST['tablename'])."&amp;action=column_create&amp;confirm=1' method='post'>";
					echo "<input type='hidden' name='tablename' value='".htmlencode($name)."'/>";
					echo "<input type='hidden' name='rows' value='".$num."'/>";
					echo "<table border='0' cellpadding='2' cellspacing='1' class='viewTable'>";
					echo "<tr>";
					...
					echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_POST['tablename'])."&amp;action=column_view'>".$lang['cancel']."</a>";
					echo "</td>";
					echo "</tr>";
					echo "</table>";
					echo "</form>";
			...
			case "column_confirm":
				...
				else
				{
					...
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=".$_REQUEST['action2']."&amp;confirm=1&amp;pk=".urlencode($pkVal)."' method='post'>";
					echo "<div class='confirm'>";
					printf($lang['ques_'.$_REQUEST['action2']], htmlencode($str), htmlencode($_GET['table']));
					echo "<br/><br/>";
					echo "<input type='submit' value='".$lang['confirm']."' class='btn'/> ";
					echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=column_view'>".$lang['cancel']."</a>";
					echo "</div>";
				}
				break;
			/////////////////////////////////////////////// edit column
			case "column_edit":
				...
				else
				{
					...
					$name = $_GET['table'];
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($name)."&amp;action=column_edit&amp;confirm=1' method='post'>";
					echo "<input type='hidden' name='tablename' value='".htmlencode($name)."'/>";
			...
			/////////////////////////////////////////////// delete index
			case "index_delete":
				echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=index_delete&amp;pk=".urlencode($_GET['pk'])."&amp;confirm=1' method='post'>";
				echo "<div class='confirm'>";
			...
			/////////////////////////////////////////////// delete trigger
			case "trigger_delete":
				echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_GET['table'])."&amp;action=trigger_delete&amp;pk=".urlencode($_GET['pk'])."&amp;confirm=1' method='post'>";
				echo "<div class='confirm'>";
			...
			case "trigger_create":
				...
				{
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_POST['tablename'])."&amp;action=trigger_create&amp;confirm=1' method='post'>";
			...
			case "index_create":
				...
				{
					echo "<form action='".$_SERVER[REQUEST_URI]."&table=".urlencode($_POST['tablename'])."&amp;action=index_create&amp;confirm=1' method='post'>";
	...
	if(!isset($_GET['table']) && !isset($_GET['confirm']) && (!isset($_GET['action']) || (isset($_GET['action']) && $_GET['action']!="table_create"))) //the absence of these fields means we are viewing the database homepage
	{
		...
		echo "<a href='".$_SERVER[REQUEST_URI]."&view=structure' ";
		if($view=="structure")
			echo "class='tab_pressed'";
		else
			echo "class='tab'";
		echo ">".$lang['struct']."</a>";
		echo "<a href='".$_SERVER[REQUEST_URI]."&view=sql' ";
		if($view=="sql")
			echo "class='tab_pressed'";
		else
			echo "class='tab'";
		echo ">".$lang['sql']."</a>";
		echo "<a href='".$_SERVER[REQUEST_URI]."&view=export' ";
		if($view=="export")
			echo "class='tab_pressed'";
		else
			echo "class='tab'";
		echo ">".$lang['export']."</a>";
		echo "<a href='".$_SERVER[REQUEST_URI]."&view=import' ";
		if($view=="import")
			echo "class='tab_pressed'";
		else
			echo "class='tab'";
		echo ">".$lang['import']."</a>";
		echo "<a href='".$_SERVER[REQUEST_URI]."&view=vacuum' ";
		if($view=="vacuum")
			echo "class='tab_pressed'";
		else
			echo "class='tab'";
		...
		if($directory!==false && is_writable($directory))
		{
			echo "<a href='".$_SERVER[REQUEST_URI]."&view=rename' ";
			if($view=="rename")
				echo "class='tab_pressed'";
			else
				echo "class='tab'";
			...
			echo "<a href='".$_SERVER[REQUEST_URI]."&view=delete' title='".$lang['db_del']."' ";
			if($view=="delete")
		...
		if($view=="structure") //database structure - view of all the tables
		{
			...
			else
			{
				...
				echo "<td class='tdheader'>";
				echo "<a href='".$_SERVER[REQUEST_URI]."&sort=type";
				if(isset($_SESSION[COOKIENAME.'sortTables']))
				...
				echo "<td class='tdheader'>";
				echo "<a href='".$_SERVER[REQUEST_URI]."&sort=name";
				if(isset($_SESSION[COOKIENAME.'sortTables']))
				...
				for($i=0; $i<sizeof($result); $i++)
				{
					...
					{
						$skippedTables = true;
						$records = "<a href='".$_SERVER[REQUEST_URI]."&forceCount=1'>?</a>";
					}
					else
					...
					if($result[$i]['type']=="table")
					{
						...
						echo "</td>";
						echo $tdWithClassLeft;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=row_view'>".htmlencode($result[$i]['name'])."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=row_view'>".$lang['browse']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=column_view'>".$lang['struct']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_sql'>".$lang['sql']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_search'>".$lang['srch']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=row_create'>".$lang['insert']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_export'>".$lang['export']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_import'>".$lang['import']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_rename'>".$lang['rename']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_empty' class='empty'>".$lang['empty']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_drop' class='drop'>".$lang['drop']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo $records;
						echo "</td>";
					...
					else
					{
						...
						echo "</td>";
						echo $tdWithClassLeft;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=row_view&amp;view=1'>".htmlencode($result[$i]['name'])."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=row_view&amp;view=1'>".$lang['browse']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=column_view&amp;view=1'>".$lang['struct']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_sql&amp;view=1'>".$lang['sql']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_search&amp;view=1'>".$lang['srch']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "";
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=table_export&amp;view=1'>".$lang['export']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo "";
						echo "</td>";
						...
						echo "</td>";
						echo $tdWithClass;
						echo "<a href='".$_SERVER[REQUEST_URI]."&table=".urlencode($result[$i]['name'])."&amp;action=view_drop&amp;view=1' class='drop'>".$lang['drop']."</a>";
						echo "</td>";
						echo $tdWithClass;
						echo $records;
						echo "</td>";
				...
				echo "<td class='tdheader' colspan='1' style='text-align:right;'>".$totalRecords.($skippedTables?" <a href='".$_SERVER[REQUEST_URI]."&forceCount=1'>+ ?</a>":"")."</td>";
				echo "</tr>";
				echo "</table>";
				echo "<br/>";
				if($skippedTables)
					echo "<div class='confirm' style='margin-bottom:20px;'>".sprintf($lang["counting_skipped"],"<a href='".$_SERVER[REQUEST_URI]."&forceCount=1'>","</a>")."</div>";
			}
			echo "<fieldset>";
			echo "<legend><b>".$lang['create_tbl_db']." '".htmlencode($db->getName())."'</b></legend>";
			echo "<form action='".$_SERVER[REQUEST_URI]."&action=table_create' method='post'>";
			...
			echo "<form action='".$_SERVER[REQUEST_URI]."&action=view_create&amp;confirm=1' method='post'>";
		...
		else if($view=="sql") //database SQL editor
		{
			...
			echo "<fieldset>";
			echo "<legend><b>".sprintf($lang['run_sql'],htmlencode($db->getName()))."</b></legend>";
			echo "<form action='".$_SERVER[REQUEST_URI]."&view=sql' method='post'>";
		...
		else if($view=="vacuum")
		{
			...
			echo "<form method='post' action='".$_SERVER[REQUEST_URI]."&view=vacuum'>";
		...
		{
			echo "<form method='post' action='".$_SERVER[REQUEST_URI]."&view=export'>";
			echo "<fieldset style='float:left; width:260px; margin-right:20px;'><legend><b>".$lang['export']."</b></legend>";
		...
		else if($view=="import")
		{
			...
			echo "<form method='post' action='".$_SERVER[REQUEST_URI]."&view=import' enctype='multipart/form-data'>";
		...
		else if($view=="rename")
		{
			...
			echo "<form action='".$_SERVER[REQUEST_URI]."&view=rename&amp;database_rename=1' method='post'>";
		...
		{
			echo "<form action='".$_SERVER[REQUEST_URI]."&database_delete=1' method='post'>";
			echo "<div class='confirm'>";
	...
	echo "<span style='font-size:11px;'>".$lang['powered']." <a href='".PROJECT_URL."' target='_blank' style='font-size:11px;'>".PROJECT."</a> | ";
	printf($lang['page_gen'], $pageTimer);
	echo "<div style='width:100%; text-align:right; font-size:11px;'>Created by <a href='https://sven-goessling.de' target='_blank'>Sven Goessling</a></div></span>";
	echo "</td></tr></table>";
...
class Database
{
	...
	public function showError()
	{
		...
		echo "<b>PDO SQLite Driver</b>: ".($PDOSqliteDriver ? $lang['installed'] : $lang['not_installed']).". Open Shell in a Box and execute: sudo apt-get update && sudo apt-get install php5-sqlite -y<br/>";
