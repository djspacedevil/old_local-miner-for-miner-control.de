...
jQuery(document).on('mousedown', 'a[href="http://willy-tech.de/kontakt/"]', function(e)
{
	...
	if (jQuery('#feedback').length == 0)
	{
		...
		jQuery.get('resources/library/etc/feedback_stats.php', {url: req_url}, function(data)
		{
			...
			jQuery('#feedback .inner').append('<iframe style="display: none;" name="iframe_feedback">Dein Browser unterstützt keine eingebetteten Frames. Folge einfach diesem Link: <a href="http://willy-tech.de/kontakt/" target="_blank">Kontakt</a></iframe>');
